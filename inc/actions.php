...
if (isset($_POST['dodajucenika'])) {
    ...
    $dodajucenika = dodajUcenika($ime, $prezime, $ime_oca, $ime_majke, $prezime_majke, $datum_rodjenja, $jmbg, $spol, $adresa, $mjesto, $skolska_godina, $razred, $udaljenost, $iznos, $banka, $ziro_racun, $ustanova, $status_uplate, $status, $napomena);
    ...
    if ($dodajucenika) {
        ...
        exit; // Prekini skriptu da vidiš poruku
    }
}
