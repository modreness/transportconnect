...
<<<<<<< HEAD
                    ...
                    <div class="smallfield">
                        ...
                        id="nosilac_racuna"
                        name="nosilac_racuna"
                        placeholder="Nositelj računa"
                        value="<?php echo htmlspecialchars($detaljiucenika['nosilac_racuna'] ?? '', ENT_QUOTES); ?>"
                        maxlength="80"
                        required>
                </div>
                <div class="smallfield">
                    ...
                    inputmode="numeric"
                    pattern="\d{13}"
                    title="Unesite tačno 13 cifara"
                    placeholder="JMBG roditelja ili staratelja"
                    value="<?php echo htmlspecialchars($detaljiucenika['jmbg_roditelja'] ?? '', ENT_QUOTES); ?>">
                    </div>
                     <!---->
