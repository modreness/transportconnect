<!--Obavijesti-->
    ...
    elseif (isset($_GET['status']) && $_GET['status'] === 'ucenik-greska') {
        echo '<div class="greska">
            <center>Dogodila se greška pri dodavanju učenika. Pokušajte ponovo ili kontaktirajte administratora.</center>
        </div>';
    }
    elseif (isset($_GET['action']) && $_GET['action'] === 'ucenik'
        && isset($_GET['status']) && $_GET['status'] === 'edit-uspjesan') {
        echo '<div class="uspjesno">
            <center>Podaci učenika su uspješno uređeni.</center>
        </div>';
    }
    elseif (isset($_GET['action']) && $_GET['action'] === 'ucenik'
        && isset($_GET['status']) && $_GET['status'] === 'edit-greska') {
        echo '<div class="greska">
            <center>Greška pri uređivanju podataka učenika. Pokušajte ponovo.</center>
        </div>';
    }
